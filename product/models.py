...
class Product(models.Model):
    ...
    stock = models.PositiveIntegerField(verbose_name="موجودی در انبار", default=0)
...
class ProductImage(models.Model):
    ...
    image = models.ImageField(upload_to=imageuploader.upload_product_image, verbose_name="تصویر")
    alt_text = models.CharField(max_length=100, blank=True, verbose_name="متن جایگزین تصویر")
